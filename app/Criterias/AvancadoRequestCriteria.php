 ...
 */
class AvancadoRequestCriteria implements CriteriaInterface
{
    /**
                    ...
                    if ( $isFirstField || $modelForceAndWhere ) {
                        if (!is_null($value)) {
                            if(!is_null($relation)) {
                                ...
                                $tipo = app('metadata_recurso')->getTipoCampoPara($field);

                                switch ($tipo) {
                                    case 'data':
                                        $query->where(\DB::raw($modelTableName.'.'."$field::date"), $condition, $value);
                                        break;
                                    case 'foreign':
